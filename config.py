"""
config.py - Configuration parameters and constants for JGP 2026 Quantitative Dashboard
"""
...
# Volatility annualization factor and default rolling window
...
# Generic fallback for ETFs without explicit custom holdings breakdown
